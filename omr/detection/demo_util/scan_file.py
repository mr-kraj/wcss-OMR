...
def preprocess(image_path):
    ...
    cv2.imwrite(config["default_preprocessing_dir"] + file_name, final)
    return config["default_preprocessing_dir"] + file_name

def parse_config(path):
    config = json.load(open(BASE_PATH + "/omr/detection/demo_util/util_scanner_config.json"))
